  ...
  return (
    <Layout>
      <div className=" w-full relative mb-4">
        <h1 className=" text-center text-lg font-semibold">Exclusive Products</h1>
      </div>
      ...
      <div className="grid gap-4 grid-cols-4 w-full max-w-screen-lg max-lg:grid-cols-3 place-items-center max-sm:grid-cols-2">
        {
          renderView()
        }
      </div>
